...
ROOT=Path('/Users/grant/IdeaProjects/myopencart'); DATE='2026-08-04'; BASE='https://shoplovanest.com'
slugs=['adult-toy-cleaner-safety-guide','top-rated-male-masturbators-checklist']
refs=['fda.gov','cdc.gov','ftc.gov','cpsc.gov']
...
for slug in slugs:
 ...
 checks={
  ...
  'adult_safe_language':not re.search(r'\b(teen|minor|xxx|cure|treats|guaranteed hardness|fertility)\b', text, re.I),'natural_english_depth': all(k in text for k in ['Red Flags','References and useful sources','Shop and learn next'])}
...
(ROOT/'output/daily_blog_validation_2026-08-04.json').write_text(json.dumps(out,indent=2),encoding='utf-8')
