...
ROOT=Path('/Users/grant/IdeaProjects/myopencart'); BLOG=ROOT/'upload/blog'; DATE='2026-07-14'
slugs=['strap-on-adult-toy-buyer-guide','bdsm-adult-toys-consent-safety-guide']
...
for slug in slugs:
    ...
    checks={
      ...
      'authority_refs': len(re.findall(r'rel="nofollow noopener"',html))>=4 and any(x in html for x in ['consumer.ftc.gov','www.ftc.gov']) and any(x in html for x in ['cpsc.gov','plannedparenthood.org','nhs.uk']),
      ...
      'topic_specific_depth': (('harness' in html.lower() and 'attachment' in html.lower() and 'consent' in html.lower()) if slug.startswith('strap-on') else ('consent' in html.lower() and 'release' in html.lower() and 'boundaries' in html.lower())),
