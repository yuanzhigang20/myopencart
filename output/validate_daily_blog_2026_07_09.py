...
DATE='2026-07-09'
SLUGS=['best-bullet-vibrator-guide','adult-toy-advent-calendar-guide']
...
def article_check(slug):
    ...
    checks={
      ...
      'topic_specific_depth': ('compact' in text.lower() and 'controls' in text.lower() and 'water-resistance' in text.lower()) if 'bullet' in slug else ('consent' in text.lower() and 'hygiene' in text.lower() and 'gift' in text.lower()),
