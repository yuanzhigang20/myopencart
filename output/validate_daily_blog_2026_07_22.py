...
import re,json
ROOT=Path('/Users/grant/IdeaProjects/myopencart'); DATE='2026-07-22'; BASE='https://shoplovanest.com'
slugs=['waterproof-vibrator-ratings-cleaning-guide','adult-toy-delivery-privacy-guide']
