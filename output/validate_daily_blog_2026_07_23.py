...
import re,json
ROOT=Path('/Users/grant/IdeaProjects/myopencart'); DATE='2026-07-23'; BASE='https://shoplovanest.com'
slugs=['connected-adult-toys-privacy-security-guide','body-safe-glass-toys-material-guide']
...
for slug in slugs:
 url=f'{BASE}/blog/{slug}/'; chunk=sm[sm.find(url):sm.find(url)+2000] if url in sm else ''
...
print(json.dumps(state['content_quality_validation'],indent=2)[:12000])
